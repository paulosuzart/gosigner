  ...
  <body class="logged_in page-blob  env-production">
    ...
    <div class="subnavd" id="main">
      <div id="header" class="true">
          ...
          <a class="logo boring" href="https://github.com/organizations/rasea">
    ...
    <div class="userbox">
      <div class="avatarname">
        <a href="https://github.com/paulosuzart"><img src="https://secure.gravatar.com/avatar/3c4d6e49c62a7db180a095900783ffc5?s=140&d=https://d3nwyuy0nl342s.cloudfront.net%2Fimages%2Fgravatars%2Fgravatar-140.png" alt="" width="20" height="20"  /></a>
        <a href="https://github.com/paulosuzart" class="name">paulosuzart</a>

        
        
      </div>
      <ul class="usernav">
        <li><a href="https://github.com/organizations/rasea">Dashboard</a></li>
        <li>
    ...
    <ul class="actions">
        ...
        <li>
          <a href="/douglascrockford/JSON-js/toggle_watch" class="minibutton btn-watch " id="watch_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', 'cf2d20fa4c15047c8afa1e8bf23e8b54e40ba6e3'); f.appendChild(s);f.submit();return false;" style="display:none"><span><span class="icon"></span>Watch</span></a>
          <a href="/douglascrockford/JSON-js/toggle_watch" class="minibutton btn-watch " id="unwatch_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', 'cf2d20fa4c15047c8afa1e8bf23e8b54e40ba6e3'); f.appendChild(s);f.submit();return false;" style="display:none"><span><span class="icon"></span>Unwatch</span></a>
            ...
            <li class="for-notforked" style="display:none"><a href="/douglascrockford/JSON-js/fork" class="minibutton btn-fork " id="fork_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', 'cf2d20fa4c15047c8afa1e8bf23e8b54e40ba6e3'); f.appendChild(s);f.submit();return false;"><span><span class="icon"></span>Fork</span></a></li>
      ...
      <li class="repostats">
        <ul class="repo-stats">
          <li class="watchers"><a href="/douglascrockford/JSON-js/watchers" title="Watchers" class="tooltipped downwards">552</a></li>
          <li class="forks"><a href="/douglascrockford/JSON-js/network" title="Forks" class="tooltipped downwards">28</a></li>
        </ul>
      </li>
    </ul>
  ...
  <ul>
    ...
    <div id="repo_details" class="metabox clearfix">
      ...
      <div id="repository_description_edit" style="display:none;" class="inline-edit">
        <form action="/douglascrockford/JSON-js/admin/update" method="post"><div style="margin:0;padding:0"><input name="authenticity_token" type="hidden" value="cf2d20fa4c15047c8afa1e8bf23e8b54e40ba6e3" /></div>
  ...
  <img src="https://d3nwyuy0nl342s.cloudfront.net/images/modules/ajax/big_spinner_336699.gif" height="32" width="32">
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.05777s from fe1.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
    ...
    <script>window._auth_token = "cf2d20fa4c15047c8afa1e8bf23e8b54e40ba6e3"</script>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <script>(function(){var d=document;var e=d.createElement("script");e.async=true;e.src="https://d1ros97qkrwjf5.cloudfront.net/10/eum/rum.js	";var s=d.getElementsByTagName("script")[0];s.parentNode.insertBefore(e,s);})();NREUMQ.push(["nrf2","beacon-3.newrelic.com","2f94e4d8c2",64799,"dw1bEBZcX1RWRhoRD18LGgcRQUFdXUA=",0,140,new Date().getTime()])</script>
  </body>
</html>
